...
public class CopyData extends CopyBase {

	public CopyData(Integer nodeId) {
		super(nodeId);
	}

	public CopyData(String[] args) {
		super(args);
	}
	...
	public void copyDoctorRange(Connection connMetro, Connection connSkyOne, Long startDate, Date fromDate,
		...
		long t1 = System.currentTimeMillis();
		log.info("copyPatient start copy: " + startDate);
		String sqlMetro = "select * from \"TE_PhieuCLS\" where \"Trangthai\" is not null ";
...
//					Date dateCreated = rsMetro.getDate("date_created");
					...
					//updatePartner(connSkyOne, doctor_id, fullname, title, address, phone, email, sex, age,digitalsignature);
